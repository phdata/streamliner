...
- [User Guide](#user-guide)
  ...
  * [Templates](#templates)
    * [Hadoop](#hadoop-templates)
    * [Snowflake](#snowflake-templates)
  * [Packaging Streamliner](#packaging-streamliner)
...
![Streamliner pipeline example](docs/images/streamliner_pipeline.png)
...
![Streamliner_hadoop example](docs/images/streamliner_hadoop_example.png)
...
### Hadoop Templates
#### [Incremental With Kudu](src/main/resources/templates/hadoop/incremental-with-kudu)
...
#### [Kudu Table DDL](src/main/resources/templates/hadoop/kudu-table-ddl)
Creates kudu tables.
...
#### [Truncate Reload](src/main/resources/templates/hadoop/truncate-reload)
...
### Snowflake Templates
#### [Snowflake AWS DMS Merge](src/main/resources/templates/snowflake/snowflake-aws-dms-merge)
...
#### [Snowflake Snowpipe Append](src/main/resources/templates/snowflake/snowflake-snowpipe-append)

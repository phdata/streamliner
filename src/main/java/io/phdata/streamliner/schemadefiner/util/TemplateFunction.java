...
public class TemplateFunction {
  ...
  final static String[] zeroScaleSuffixes = {
    "_KEY",
    "_ID",
    "_NUM",
    "_CNUM",
  ...
  public static String mapDataType(
      ColumnDefinition column, scala.collection.immutable.Map<String, scala.collection.immutable.Map<String, String>>
          typeMapping, String storageFormat) {

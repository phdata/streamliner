...
import io.phdata.pipewrench.configuration.{ConfigurationBuilder, Default, YamlSupport}
  ...
  def main(args: Array[String]): Unit = {
    ...
    cli.subcommand match {
      case Some(cli.configuration) =>
        ...
        val outputDirectory = configurationOutputDirectory(configuration, cli.configuration.outputPath.toOption)
      ...
      case Some(cli.produceScripts) =>
        ...
        val typeMapping = readTypeMappingFile(cli.produceScripts.typeMappingFile.getOrElse(TYPE_MAPPING_FILE))

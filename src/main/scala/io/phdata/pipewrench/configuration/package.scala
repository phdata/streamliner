...
package object configuration {
  ...
  case class Jdbc(driverClass: Option[String],
                  url: String,
                  username: String,
                  password: String,
                  schema: String,
  ...
  case class Hadoop(username: String,
                    password: String,
  ...
  case class PipewrenchConfiguration(configuration: Configuration,
                                     tables: Seq[TableDefinition])

  case class TableDefinition(sourceName: String,
  ...
  case class ColumnDefinition(sourceName: String,
                              destinationName: String,
                              dataType: String,
